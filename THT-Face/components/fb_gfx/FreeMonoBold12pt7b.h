...
const FLASH uint8_t FreeMonoBold12pt7bBitmaps[] = {
    ...
    0x3F, 0xC3, 0xFC, 0xF0, 0xFF, 0x0F, 0x60, 0x66, 0x06, 0x60, 0x66, 0x06, //0x3F, 0xC3, 0xFC,// U start  0xFF, 0xFF, 0xFF, 0x60, 0x66, 0x06, 0x60, 0x66, 0x06, change U
...
const FLASH GFXglyph FreeMonoBold12pt7bGlyphs[] = {
    {0, 0, 0, 14, 0, 1},        // 0x20 ' '
    {0, 4, 15, 14, 5, -14},     // 0x21 '!'
    {8, 8, 7, 14, 3, -13},      // 0x22 '"'
