...
void st7789_init(void)
{
    ...
    printf("sang:ST7789 initialization.\n");
...
static void st7789_set_orientation(uint8_t orientation)
{
    ...
    printf("Display orientation: %s", orientation_str[orientation]);
    ...
    printf("sang:0x36 command value: 0x%02X---------------\r\n", data[orientation]);
