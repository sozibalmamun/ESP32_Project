...
const DATA_FLASH unsigned char framebase[] = {
...
const DATA_FLASH unsigned char framask[] = {
...
const DATA_FLASH unsigned fmtword[] = {
...
const DATA_FLASH unsigned char g0log[256] = {
...
const DATA_FLASH unsigned char g0exp[256] = {
...
qrcode_t qrInfo={
    ...
    .xOfset = 268,  // Starting x coordinate 269
...
void render(int x, int y, int color ,camera_fb_t *buff){
    ...
    x=(x*MULTIPLY)+qrInfo.xOfset;
    y=(y*MULTIPLY)+qrInfo.yOfset;
