...
static void lvgl_task(void *arg) // GUI浠诲�?
{
   ...
   ESP_ERROR_CHECK(esp_timer_start_periodic(periodic_timer, 10 * 1000));
	...
	lv_obj_set_size(imgCamera, 320, 240); //璁剧疆澶у�?
...
//	lv_obj_del(imgCamera);//鍒犻櫎鍥剧墖
   ...
   lv_style_set_text_font(&mystyle,&myfont); //寮曠敤�?�楀�?
